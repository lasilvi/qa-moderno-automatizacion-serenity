...
| CP-05 | H1 - Intento de compra con producto desactivado. Backend responde 400 Bad Request y frontend notifica indisponibilidad. | No aplica (Caso excluido) | Producto desactivado no implementado, Caso excluido del alcance funcional definido para la entrega actual. |
...
| CP-12 | H2 - Eliminación masiva (Soft Delete). Marca pedidos como deleted=true y los oculta de la vista manteniéndolos en BD. | No aplica (Caso excluido) | Eliminación masiva, Funcionalidad no implementada ni incluida dentro del alcance del sprint actual. |
